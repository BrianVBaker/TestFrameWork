...
namespace BatchRunner
{
    public class SeleniumActions
    {
        ...
        public static bool TestObjectExists(By str, int wait, string elem, IWebDriver driver)
        {
            ...
            try
            {
                ...
                while (ct <= timer)
                {
                    if (ObjectIsEnabled(Str, timer, driver))
                    {
                        ...
                        log.Info("Element " + Str + " Java clicked");
                        return true;
                    }
                    Thread.Sleep(1);
                    ct++;
            ...
            try
            {
                ...
                while (ct <= timer)
                {
                    if (ObjectIsEnabled(Str, timer, driver))
                    {
                        ...
                        Rtn = true;
                        log.Info("Element " + Str + " Submitted");
                        return Rtn;
                    }
            ...
            try
            {
                ...
                while (ct <= timer)
                {
                    if (ObjectIsEnabled(Str, timer, driver))
                    {
                        ...
                        log.Info("Element " + Str + " text returned");
                        return Rtn;
                    }
                    Thread.Sleep(1);
                    ct++;
            ...
            try
            {
                ...
                while (ct <= timer && !Notselected)
                {
...

                    {
                        ...
                        RunTesting.UpdateStepValues(TestRun.TestStep, "ListCount", items.FindElements(By.TagName(vals[0])).Count.ToString());
        ...
        public static bool sendKeys(By Str, IWebDriver driver, int timer, string val)
        {
            ...
            while (ct <= timer)
            {
                try
                {
                    ...
                    log.Info("Chars " + val + " sent to Element " + Str);
                    return true;
                }
                catch (Exception) { }
        ...
        public static bool Enter(By Str, IWebDriver driver, int timer, string val)
        {
            ...
            while (ct <= timer)
            {
                try
                {
                    ...
                    driver.FindElement(Str).SendKeys(OpenQA.Selenium.Keys.Enter);
                    log.Info("Chars Keys.Enter sent to Element " + Str);
                    return true;
                }
                catch (Exception) { }
        ...
        public static bool Escape(By Str, IWebDriver driver, int timer, string val)
        {
            ...
            while (ct <= timer)
            {
                try
                {
                    driver.FindElement(Str).SendKeys(OpenQA.Selenium.Keys.Escape);
                    log.Info("Chars Keys.Escape sent to Element " + Str);
                    return true;
                }
                catch (Exception) { }
